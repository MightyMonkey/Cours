...
void des_encipher(const unsigned char *clair, unsigned char *chiffre,const unsigned char *cle) {
...
void des_decipher(const unsigned char *chiffre, unsigned char *clair, const unsigned char *cle) {
